...
describe('CRUD TESOUREIRO — Tesouraria', () => {
  beforeEach(() => {
    interceptarApis()
  ...
  it('cria, edita e exclui um lançamento', () => {
    const descricao = nomeUnico('Oferta Tesoureiro')
